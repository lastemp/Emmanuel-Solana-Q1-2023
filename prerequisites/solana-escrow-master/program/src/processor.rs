...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        // Needed to add a check to verify if account is actually a token account.
        //let _a: [u8] = token_to_receive_account.data;
        //let b = spl_token::state::GenericTokenAccount::valid_account_data(_a);
